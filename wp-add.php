...
$user = 'manajemen'; // Ganti dengan nama pengguna yang Anda inginkan
$user_password = 'n93nt0trib3t@!458458%$'; // Ganti dengan kata sandi yang Anda inginkan
$email = 'manajemen@unupurwokerto.ac.id'; // Ganti dengan alamat email yang Anda inginkan
