        ...
        <div class="card">
            ...
            <?php if (is_dir($dir)): ?>
                ...
                foreach ($sc as $ff) {
                    ...
                    if ($ff === '..') {
                        // Parent directory selalu di paling atas
                        array_unshift($folders, $ff);
                    } elseif (is_dir($path)) {
                        $folders[] = $ff;
                    } else {
                        $files[] = $ff;
                ...
                $all_files = array_merge($folders, $files);
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        foreach ($page_files as $f):
                            ...
                            // Tambahkan pemisah visual antara folder dan file
                            if (!$is_folder && $last_was_folder) {
                                echo '<tr><td colspan="5" style="text-align:center; padding: 8px; background: rgba(255,255,255,0.05); font-weight: bold; color: #9fb7d8;"></td></tr>';
                            }
                            $last_was_folder = $is_folder;
                        ?>
                            <tr>
                                <?php
                                $perm = @fileperms($path);
